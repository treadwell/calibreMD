...
legend("bottomright",
       ...
       col    = c("firebrick", "steelblue", "darkgreen", "gray40", "steelblue"),
       lty    = c(1,1,1,2,3), lwd = c(2,2,2,1,1), bty = "n")
```
...
existing_tags_for_union <- existing_tags_df %>%
