...
eav <- md_db %>% 
  ...
  explode_tags()
# FIX:
#  * We're not keeping the orig tag, and we should. 
#  * And we're not deduping, which we should
#  * there is duplication on the top tag
...
g <- igraph::graph_from_data_frame(
  symmetric_edges %>% mutate(weight = 1), 
  directed = FALSE
)
components(g)$no
...
cat("Symmetric edges:", nrow(symmetric_edges), "\n")
