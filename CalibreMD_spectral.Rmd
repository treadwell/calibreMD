...
unified_meta_train <- build_unified_metadata(eav, book_ids, tag_names, node_types, binary_embedding_train, md_db)
...
# Train Encoder
```{r}
model <- train_encoder(train_data$X, train_data$Y)
...
Next steps
* Evaluate projected codes: Spearman correlation between recommendations from in-sample code and out-of-sample (original) code
* Evaluate test codes
